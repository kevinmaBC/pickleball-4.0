...
const CACHE='pb40-v22';
const CORE=[
  './','./index.html','./manifest.json',
  './css/app.css',
  './js/i18n.js','./js/namespace.js','./js/config-loader.js','./js/storage.js','./js/metrics.js','./js/review-engine.js','./js/trend-engine.js','./js/retest-engine.js','./js/review-ui.js','./js/session-execution-engine.js','./js/training-readiness-engine.js','./js/training-ui.js','./js/preview.js','./js/app.js','./js/assessment.js',
